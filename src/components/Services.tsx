...
const services = [
   ...
   {
      title: "Doctors",
      description: "Streamlined practice management and direct patient engagement.",
      icon: Stethoscope,
   ...
   {
      title: "Therapy",
      description: "Continuous mental and physical health tracking.",
      icon: Smile,
   ...
   return (
      <section id="services" className="py-24 bg-slate-50 relative">
         <div className="container px-4 md:px-6 mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-6 auto-rows-[200px] md:auto-rows-[250px] max-w-6xl mx-auto">
               {services.map((service, i) => {
                  ...
                  return (
                     <motion.div
                        ...
                        className={cn(
                           "group relative overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 p-6 md:p-8 flex flex-col justify-between",
                           service.className
                        )}
                     >
