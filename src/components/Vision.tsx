...
export default function Vision() {
   return (
      <section id="vision" className="relative py-16 md:py-32 bg-slate-950 overflow-hidden">
         ...
         <div className="container relative z-10 px-4 md:px-6 mx-auto text-center max-w-4xl">
            ...
            >
               <h2 className="text-sm font-semibold text-healthcare-cyan-400 uppercase tracking-widest mb-6 md:mb-8">
                  Our Vision
               </h2>

               <blockquote className="text-2xl md:text-5xl lg:text-6xl font-outfit font-medium text-white leading-tight mb-8 md:mb-12">
               ...
               <div className="w-12 md:w-16 h-1 bg-healthcare-blue-500 mx-auto rounded-full mb-6 md:mb-8" />

               <p className="text-slate-400 text-base md:text-xl max-w-2xl mx-auto text-balance">
